...
* [Documento MYSQL](parte1\api\db\database.sql) para criação da Base de Dados.
* [Documento Docker-compose](parte1\api\docker-compose.yml)para puxar as imagens dos repositórios DockerHub e montar a aplicação.
